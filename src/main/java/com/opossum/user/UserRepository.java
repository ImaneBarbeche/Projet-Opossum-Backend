 ...
 * Hérite automatiquement des méthodes CRUD de JpaRepository (findAll, findById, save, delete, etc.).
 * Permet aussi de définir des requêtes personnalisées pour des besoins spécifiques.
 */
...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    /**
     * Compte le nombre d'utilisateurs ayant un email donné (pour vérifier l'unicité)
